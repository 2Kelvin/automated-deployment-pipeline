...
![CI/CD Pipeline](https://img.shields.io/github/actions/workflow/status/2Kelvin/automated-ci.yaml/check-linting-and-run-tests.yaml?label=CI/CD%20Pipeline&style=for-the-badge)
